...
public:
    ...
    Stock(const std::string& id, const std::string& name, const std::string& desc, const Price& price, const unsigned& on_hand);
};
...
public:
    ...
    void setData(const Stock s);
    void setCData(const Coin c);
